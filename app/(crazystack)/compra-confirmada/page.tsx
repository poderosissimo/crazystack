...
export default function PurchaseConfirmation() {
  const sendWhatsAppMessage = () => {
    const message = encodeURIComponent(
      "Olá! Acabei de fazer a compra do curso CrazyStack. Aqui está o meu comprovante de pagamento.",
    );
        ...
        <Card className="max-w-2xl mx-auto bg-gray-900 border-lime-500 p-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-300">
              Obrigado por se juntar ao CrazyStack!
            </p>
          </div>
          <div className="mt-8 space-y-6">
            <div className="bg-black rounded-lg p-4">
              <h2 className="text-lg font-semibold text-lime-300 mb-2">
                Detalhes da Compra:
              </h2>
              <ul className="space-y-2 text-gray-300">
                <li>
                  <strong>Curso:</strong> CrazyStack - O Bootcamp do Dev Doido
                </li>
                <li>
                  <strong>Valor:</strong> R$ 99,00
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-300">
                ...
                <li>
                  Aguarde a confirmação e as instruções de acesso ao curso
                  (enviaremos em breve)
                </li>
                <li>
                  Após receber o acesso, configure sua conta na plataforma de
                  ensino
                </li>
            ...
            <p className="text-center text-sm text-gray-400 mt-4">
              Após enviar o comprovante, responderemos em breve com as
