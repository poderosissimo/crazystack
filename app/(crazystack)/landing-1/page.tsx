            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-green-500">
                  CrazyStack
                  <br />O Bootcamp do Dev Doido
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-400 md:text-xl">
                  Domine React & Node.js: Aprenda React consumindo uma API
                  FULMINANTE feita com Node.js, MongoDB e Fastify.
                </p>
              </div>
        ...
        >
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-lime-400 mb-8 text-center">
              O Único Curso do Brasil com Tecnologias Avançadas
            </h2>
            <p className="text-xl text-gray-400 text-center mb-12">
              Aprenda do zero a criar uma API Node.js completa e versátil,
              integrando as tecnologias mais demandadas do mercado.
            </p>
            <div className="grid gap-8 md:grid-cols-3">
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Aprenda a trabalhar com MongoDB e PostgreSQL, dominando as
                    peculiaridades de bancos NoSQL e SQL.
                  </p>
                </div>
              </Card>
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  <MessageSquare className="h-12 w-12 text-lime-400" />
                  <h3 className="text-xl font-bold text-lime-300">
                    Sistemas de Mensageria
                  </h3>
                  <p className="text-gray-400">
                    Domine a implementação de Kafka e RabbitMQ para criar
              ...
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  <PaymentIcon className="h-12 w-12 text-lime-400" />
                  <h3 className="text-xl font-bold text-lime-300">
                    Gateways de Pagamento
                  </h3>
                  <p className="text-gray-400">
                    Integre facilmente Woovi PIX, Stripe e Pagar.me em suas
                    aplicações para processar pagamentos.
                  </p>
                </div>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="max-w-[600px] text-gray-400">
                Aproveite esta oferta por tempo limitado e comece sua jornada
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Explore o código-fonte da nossa API robusta construída com
                    Node.js, Fastify e MongoDB.
                  </p>
                  <Link
              ...
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Veja o código do nosso frontend React, incluindo componentes
                    reutilizáveis e integração com a API.
                  </p>
                  <Link
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
              <Card className="bg-gray-900 border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Veja Design Patterns, TDD e Clean Architecture durante todo
                    curso.
                  </p>
                </div>
              </Card>
              <Card className="bg-gray-900 border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Com o Plop você gera arquivos dinamicamente com base em
                    templates.
                  </p>
                </div>
              </Card>
              <Card className="bg-gray-900 border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-lime-300">
                    Imitações aleatórias
                  </h3>
                  <p className="text-gray-400">
                    É o curso inteiro de imitações do Faustão, Silvio Santos, e
                    muito MAIS!
                  </p>
                </div>
              </Card>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Aprenda os conceitos básicos do React em 30 minutos.
                  </p>
                  <Link
              ...
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Descubra o poder do Node.js nesta aula introdutória.
                  </p>
                  <Link
              ...
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  <PlayCircle className="h-12 w-12 text-lime-400" />
                  <h3 className="text-xl font-bold text-lime-300">
                    MongoDB em 20 Minutos
                  </h3>
                  <p className="text-gray-400">
                    Uma rápida introdução ao MongoDB e suas funcionalidades.
                  </p>
                  <Link
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <Card className="bg-gray-900 border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-lime-300">
                    Assinatura PIX Mensal
                  </h3>
                  <p className="text-gray-400">
                    Aprenda a implementar um sistema de assinatura mensal usando
              ...
              <Card className="bg-gray-900 border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-400">
                    Crie uma landing page profissional para seu SaaS usando
                    Next.js e técnicas avançadas de design.
                  </p>
                  <Button className="bg-lime-500 text-black hover:bg-lime-400">
                    Saiba mais
                  </Button>
          ...
          <div className="container px-4 md:px-6">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-lime-300 hover:text-lime-400">
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger className="text-lime-300 hover:text-lime-400">
                  Módulo 3: API Avançada com Fastify
                </AccordionTrigger>
                <AccordionContent className="text-gray-400">
                  <ul className="list-disc pl-5 space-y-2">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-2/3 space-y-4">
                ...
                <p className="text-gray-400">
                  Com mais de 6 anos de experiência na área de TI, Gustavo é um
                  desenvolvedor apaixonado por criar e compartilhar conteúdo.
                  Especializado em Javascript, React, React Native e NodeJs, ele
                  traz sua experiência prática para o CrazyStack.
                </p>
                <p className="text-gray-400">
                  Criador do aplicativo de agendamentos Belezix, Gustavo
                  compartilha todas as lições aprendidas durante o
                  desenvolvimento deste projeto real no curso CrazyStack.
                </p>
                <p className="text-gray-400">
                  Atualmente, Gustavo trabalha com React.js e React Native, além
                  de ser o mantenedor do canal DevDoido no Youtube, onde
                  continua a compartilhar seu conhecimento com a comunidade de
                  desenvolvedores.
                </p>
              </div>
            </div>
        ...
        >
          <div className="container px-4 md:px-6">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-lime-300 hover:text-lime-400">
                  Onde está a ementa do curso?
                </AccordionTrigger>
                <AccordionContent className="text-gray-400">
                  No botão do fim da página você pode ver a ementa completa do
                  curso direto na página da HOTMART.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-lime-300 hover:text-lime-400">
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-gray-400">
                  O curso é projetado para aqueles com noções básicas de
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="text-gray-400">
                  Sim, oferecemos uma certificação ao final do curso para
                  aqueles que completarem todos os exercícios e desafios.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
        ...
        >
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <Card className="w-full max-w-md bg-gray-900 border-lime-500">
                <form className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="whatsapp" className="text-lime-300">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="terms" className="text-sm text-gray-400">
                      Autorizo o envio de comunicações por e-mail ou qualquer
                      outro meio e concordo com os Termos e Políticas de
                      privacidade.
                    </Label>
                  </div>
