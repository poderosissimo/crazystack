    ...
    <div className="flex flex-col min-h-screen bg-black text-gray-100">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="space-y-6 text-gray-300">
          ...
          <p>
            A CrazyStack ("nós", "nossos" ou "nossa") está comprometida em
            proteger a privacidade dos usuários do nosso site e curso online.
          ...
          <p>
            ...
            informações com provedores de serviços terceirizados que nos ajudam
            a operar nosso negócio e fornecer nossos serviços.
          </p>
          ...
          <p>
            ...
            contato conosco em: privacy@crazystack.com.br
          </p>
        </div>
      </main>
