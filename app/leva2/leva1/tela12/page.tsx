...
import { Instagram, Spotify, Upload, X } from 'lucide-react'

export default function ProfileEdit() {
  const [photos, setPhotos] = useState<string[]>(['/placeholder.svg?height=200&width=200', '/placeholder.svg?height=200&width=200'])
          ...
          <div className="grid grid-cols-3 gap-4">
            {photos.map((photo, index) => (
              <div key={index} className="relative">
                <img src={photo} alt={`Profile ${index + 1}`} className="w-full h-auto rounded-lg" />
                <Button
                  variant="destructive"
                  size="icon"
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {['Music', 'Sports', 'Travel', 'Food', 'Art', 'Gaming'].map((interest) => (
                <Button
                  key={interest}
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Slider
              ...
              step={1}
            />
            <p className="text-sm text-gray-500 mt-2">Show profiles within {distance} km</p>
          </div>
