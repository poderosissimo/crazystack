...
export default function Component({ 
  ...
  questions = [
    { id: '1', title: "What's the best programming language for beginners?", votes: 42, answers: 15, timestamp: '2h ago', tags: ['programming', 'beginners'] },
    { id: '2', title: "How does blockchain technology work?", votes: 38, answers: 7, timestamp: '4h ago', tags: ['blockchain', 'cryptocurrency'] },
    { id: '3', title: "What are the pros and cons of cloud computing?", votes: 25, answers: 9, timestamp: '1d ago', tags: ['cloud', 'computing'] },
  ]
}: CategoryPageProps) {
