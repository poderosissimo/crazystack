...
import { Star, Play, CheckCircle, Globe, ClosedCaptioning, Trophy, InfinityIcon } from 'lucide-react'
      ...
      <div className="bg-[#2d2f31] text-white">
        <div className="max-w-6xl mx-auto p-6">
          <div className="md:w-3/5">
            ...
            <p className="mb-4">Created by <a href="#" className="text-[#cec0fc] hover:underline">Jonas Schmedtmann</a></p>
            <div className="flex items-center text-sm mb-4">
              <span className="flex items-center mr-4"><Globe className="w-4 h-4 mr-1" /> English</span>
              <span className="flex items-center"><ClosedCaptioning className="w-4 h-4 mr-1" /> English [CC], Spanish [AUTO]</span>
            </div>
        ...
        <div className="md:w-2/3 text-white">
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-between text-sm mb-2">
              ...
              <button className="text-[#a435f0] hover:underline" onClick={() => setIsExpanded(!isExpanded)}>
                {isExpanded ? 'Collapse all sections' : 'Expand all sections'}
              </button>
            </div>
            <Accordion type="single" collapsible className="bg-[#2d2f31] rounded-lg">
              {['Welcome, Welcome, Welcome!', 'JavaScript Fundamentals – Part 1', 'JavaScript Fundamentals – Part 2', 'How to Navigate This Course', 'Developer Skills & Editor Setup'].map((section, index) => (
                <AccordionItem value={`item-${index}`} key={index} className="border-b border-[#3e4143]">
                  <AccordionTrigger className="px-4 py-4 hover:bg-[#3e4143] text-left">
                    <div className="flex justify-between w-full">
                      <span>{section}</span>
                      <span className="text-sm text-gray-400">6 lectures • 65min</span>
                    </div>
                  </AccordionTrigger>
          ...
          <div className="mb-6">
            ...
            {!isExpanded && (
              <button className="text-[#a435f0] mt-4 hover:underline" onClick={() => setIsExpanded(true)}>
                Show more
              </button>
            )}
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-400 mb-2">Web Developer, Designer, and Teacher</p>
                ...
                <Button variant="link" className="p-0 h-auto text-[#a435f0] hover:underline">Show more</Button>
              </div>
            </div>
          </div>
              ...
              <div className="flex-grow">
                {[5, 4, 3, 2, 1].map((rating) => (
                  <div key={rating} className="flex items-center mb-1">
                    <Progress value={rating === 5 ? 77 : rating === 4 ? 17 : 3} className="h-2 mr-2 bg-gray-600" indicatorClassName="bg-[#f69c08]" />
                    <div className="w-16 text-right text-sm text-gray-400">{rating === 5 ? '77%' : rating === 4 ? '17%' : '3%'}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <Card className="bg-[#2d2f31] border-[#3e4143]">
              <CardContent className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <span className="text-lg text-gray-400 line-through ml-2">$84.99</span>
                ...
                <Button className="w-full mb-4 bg-[#a435f0] hover:bg-[#9a2ee0] text-white">Add to cart</Button>
                <Button variant="outline" className="w-full mb-4 border-white text-white hover:bg-white hover:text-[#2d2f31]">Buy now</Button>
