  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="mb-4">
        ...
        />
        <p id="cep-info" className="text-sm text-gray-500 mt-1">
      ...
      <div className="mb-4">
        ...
        />
        <p id="cupom-info" className="text-sm text-gray-500 mt-1">
      ...
      <Button
        ...
        onClick={() =>
          window.open(
            `https://wa.me/5511999999999?text=${generateWhatsAppMessage()}`,
            "_blank",
          )
        }
      >
