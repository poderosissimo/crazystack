...
export default function Component() {
  const [filteredServices, setFilteredServices] =
    useState<MovingService[]>(mockServices);
          ...
          <Card key={service.id}>
            ...
            <CardContent>
              <p className="flex items-center mb-2">
                <MapPin className="mr-2" size={16} /> {service.location}
              </p>
              <p className="flex items-center mb-2">
                <Star className="mr-2" size={16} fill="gold" />{" "}
                {service.rating.toFixed(1)}
              </p>
              <p className="flex items-center mb-2">
                <DollarSign className="mr-2" size={16} /> A partir de R${" "}
                {service.price}
              </p>
