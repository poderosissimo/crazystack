      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="h-2 bg-gray-200 rounded-full">
              <div
                className={`h-full rounded-full ${
                  passwordStrength(password) < 3 ? 'bg-red-500' :
                  passwordStrength(password) < 5 ? 'bg-yellow-500' : 'bg-green-500'
                }`}
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="terms">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger className="underline">termos e condições</TooltipTrigger>
                <TooltipContent>
