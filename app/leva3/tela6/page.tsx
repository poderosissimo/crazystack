...
import { ChevronRight, Code, FileCode, Globe, Rocket, Zap, Lock, Star, PlayCircle, CreditCard, LayoutDashboard, Github, Database, MessageSquare, CreditCard as PaymentIcon } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-gray-100">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-900" id="unique-features">
          <div className="container px-4 md:px-6">
            ...
            <p className="text-xl text-gray-400 text-center mb-12">
              Aprenda do zero a criar uma API Node.js completa e versátil, integrando as tecnologias mais demandadas do mercado.
            </p>
            <div className="grid gap-8 md:grid-cols-3">
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  <Database className="h-12 w-12 text-lime-400" />
                  <h3 className="text-xl font-bold text-lime-300">Múltiplos Bancos de Dados</h3>
                  <p className="text-gray-400">
                    Aprenda a trabalhar com MongoDB e PostgreSQL, dominando as peculiaridades de bancos NoSQL e SQL.
                  </p>
                </div>
              </Card>
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-lime-300">Sistemas de Mensageria</h3>
                  <p className="text-gray-400">
                    Domine a implementação de Kafka e RabbitMQ para criar sistemas distribuídos e escaláveis.
                  </p>
                </div>
              </Card>
              <Card className="bg-black border-lime-500">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <h3 className="text-xl font-bold text-lime-300">Gateways de Pagamento</h3>
                  <p className="text-gray-400">
                    Integre facilmente Woovi PIX, Stripe e Pagar.me em suas aplicações para processar pagamentos.
                  </p>
                </div>
              </Card>
            </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-black" id="promotional-price">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-900" id="github-projects">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-lime-400 mb-8 text-center">
              Projetos no GitHub
            </h2>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-900" id="free-lessons">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-lime-400 mb-8">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-black" id="highlighted-lessons">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-lime-400 mb-8">
              Aulas em Destaque
            </h2>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-900" id="content">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-lime-400 mb-8">
              Conteúdo do Curso
            </h2>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-black" id="creator">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-lime-400 mb-8">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-black" id="pre-registration">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
              ...
              <Card className="w-full max-w-md bg-gray-900 border-lime-500">
                <form className="p-6 space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="name" placeholder="Digite seu nome completo" className="bg-black text-gray-100 border-lime-500" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="whatsapp" className="text-lime-300">Seu número de WhatsApp</Label>
                    <Input id="whatsapp" placeholder="Digite seu número de WhatsApp" className="bg-black text-gray-100 border-lime-500" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-lime-300">Digite seu e-mail</Label>
                    <Input id="email" type="email" placeholder="Digite seu e-mail" className="bg-black text-gray-100 border-lime-500" />
                  </div>
                  <div className="flex items-center space-x-2">
