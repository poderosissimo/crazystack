    ...
    <div className="flex flex-col min-h-screen bg-black text-gray-100">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 text-lime-400 text-center">Finalizar Compra - PIX</h1>
          <Card className="bg-gray-900 border-lime-500 p-6">
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-lime-300">Resumo do Pedido</h2>
                <div className="space-y-2 text-gray-300">
                  <p>CrazyStack - O Bootcamp do Dev Doido</p>
                  <p className="text-2xl font-bold text-lime-400">R$ 99,00</p>
                  <p className="text-sm text-gray-400"><s>R$ 600,00</s> (83% de desconto)</p>
                </div>
              </div>
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-lime-300">Seus Dados</h2>
                <form className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-lime-300">Nome Completo</Label>
                    <Input id="name" placeholder="Seu nome completo" className="bg-black text-gray-100 border-lime-500" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-lime-300">E-mail</Label>
                    <Input id="email" type="email" placeholder="seu@email.com" className="bg-black text-gray-100 border-lime-500" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="cpf" className="text-lime-300">CPF</Label>
                    <Input id="cpf" placeholder="000.000.000-00" className="bg-black text-gray-100 border-lime-500" />
                  </div>
                </form>
              </div>
            </div>
            <div className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-lime-300">Pagamento via PIX</h2>
