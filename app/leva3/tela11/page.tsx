...
import { User, Truck, MapPin, Clock, DollarSign, Bell, Shield, Save, Briefcase, Tool, Clipboard, Star, Settings, FileText, Camera } from 'lucide-react'
...
export default function ConfiguracaoAvancadaPrestador() {
  ...
  return (
    <div className="container mx-auto p-4 space-y-6 bg-background min-h-screen">
      <h1 className="text-3xl font-bold text-primary text-center mb-6">Configurações Avançadas do Prestador</h1>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="dataNascimento" type="date" value={config.dataNascimento} onChange={(e) => handleChange('dataNascimento', e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="genero">Gênero</Label>
            <Select value={config.genero} onValueChange={(value) => handleChange('genero', value)}>
              <SelectTrigger>
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        handleChange('idiomas', config.idiomas.filter(i => i !== idioma))
                      }
                    }}
                  />
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleNestedChange('redesSociais', 'facebook', e.target.value)} 
            />
            <Input 
              placeholder="Instagram" 
              value={config.redesSociais.instagram} 
              onChange={(e) => handleNestedChange('redesSociais', 'instagram', e.target.value)} 
            />
            <Input 
              placeholder="LinkedIn" 
              value={config.redesSociais.linkedin} 
              onChange={(e) => handleNestedChange('redesSociais', 'linkedin', e.target.value)} 
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            />
            <div className="text-right text-sm text-muted-foreground">{config.raioAtuacao} km</div>
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleChange('precoMinimo', Number(e.target.value))}
            />
          </div>
          <div className="space-y-2">
            <Label>Tipos de Mudança</Label>
            <div className="flex flex-wrap gap-2">
              {['residencial', 'comercial', 'internacional', 'longa-distancia'].map((tipo) => (
                <div key={tipo} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        handleChange('tiposMudanca', [...config.tiposMudanca, tipo])
                      } else {
                        handleChange('tiposMudanca', config.tiposMudanca.filter(t => t !== tipo))
                      }
                    }}
                  />
                  <Label htmlFor={`tipo-${tipo}`}>{tipo.charAt(0).toUpperCase() + tipo.slice(1)}</Label>
                </div>
              ))}
            </div>
          </div>
          <div className="space-y-2">
            <Label htmlFor="tamanhoMaximoCarga">Tamanho Máximo de Carga (m³)</Label>
            <Slider
              ...
              onValueChange={([value]) => handleChange('tamanhoMaximoCarga', value)}
            />
            <div className="text-right text-sm text-muted-foreground">{config.tamanhoMaximoCarga} m³</div>
          </div>
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleChange('pessoasEquipe', Number(e.target.value))}
            />
          </div>
          <div className="space-y-2">
            <Label>Serviços Adicionais</Label>
            <div className="flex flex-wrap gap-2">
              {['embalagem', 'desmontagem', 'montagem', 'limpeza', 'armazenamento'].map((servico) 
 ...
 => (
                <div key={servico} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        handleChange('servicosAdicionais', [...config.servicosAdicionais, servico])
                      } else {
                        handleChange('servicosAdicionais', config.servicosAdicionais.filter(s => s !== servico))
                      }
                    }}
                  />
                  <Label htmlFor={`servico-${servico}`}>{servico.charAt(0).toUpperCase() + servico.slice(1)}</Label>
                </div>
              ))}
            </div>
          </div>
              ...
              {['segunda', 'terca', 'quarta', 'quinta', 'sexta', 'sabado', 'domingo'].map((dia) => (
                <div key={dia} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        handleChange('diasTrabalho', [...config.diasTrabalho, dia])
                      } else {
                        handleChange('diasTrabalho', config.diasTrabalho.filter(d => d !== dia))
                      }
                    }}
                  />
          ...
          <div className="space-y-2">
            <Label htmlFor="tempoMinimoAntecedencia">Tempo Mínimo de Antecedência (dias)</Label>
            <Input 
              id="tempoMinimoAntecedencia" 
              type="number" 
              value={config.tempoMinimoAntecedencia} 
              onChange={(e) => handleChange('tempoMinimoAntecedencia', Number(e.target.value))}
            />
          </div>
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => handleChange('aceitaPagamentoCartao', checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => handleChange('aceitaPagamentoDinheiro', checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => handleChange('aceitaPagamentoPix', checked)}
                />
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('possuiSeguro', checked)}
            />
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Select value={config.tipoVeiculo} onValueChange={(value) => handleChange('tipoVeiculo', value)}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleChange('anoVeiculo', Number(e.target.value))}
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="capacidadeVeiculo">Capacidade do Veículo (m³)</Label>
            <Input 
              id="capacidadeVeiculo" 
              type="number" 
              value={config.capacidadeVeiculo} 
              onChange={(e) => handleChange('capacidadeVeiculo', Number(e.target.value))}
            />
          </div>
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('possuiRampa', checked)}
            />
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('possuiCarrinho', checked)}
            />
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('possuiCordas', checked)}
            />
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('possuiCobertores', checked)}
            />
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Select value={config.notaMinimaAceitavel.toString()} onValueChange={(value) => handleChange('notaMinimaAceitavel', Number(value))}>
              <SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('respostaAutomaticaAvaliacao', checked)}
            />
            <Label htmlFor="respostaAutomaticaAvaliacao">Resposta automática para avaliações</Label>
          </div>
          <div className="space-y-2">
            <Label htmlFor="tempoMaximoResposta">Tempo Máximo de Resposta (horas)</Label>
            <Input 
              id="tempoMaximoResposta" 
              type="number" 
              value={config.tempoMaximoResposta} 
              onChange={(e) => handleChange('tempoMaximoResposta', Number(e.target.value))}
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="frequenciaResumoSemanal">Frequência do Resumo Semanal</Label>
            <Select value={config.frequenciaResumoSemanal} onValueChange={(value) => handleChange('frequenciaResumoSemanal', value)}>
              <SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('notificacaoNovaOportunidade', checked)}
            />
            <Label htmlFor="notificacaoNovaOportunidade">Notificar sobre novas oportunidades</Label>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('backupAutomaticoDados', checked)}
            />
            <Label htmlFor="backupAutomaticoDados">Backup Automático de Dados</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Switch
              id="compartilharLocalizacaoTempoReal"
              checked={config.compartilharLocalizacaoTempoReal}
              onCheckedChange={(checked) => handleChange('compartilharLocalizacaoTempoReal', checked)}
            />
            <Label htmlFor="compartilharLocalizacaoTempoReal">Compartilhar Localização em Tempo Real</Label>
          </div>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Select value={config.idiomaPlataforma} onValueChange={(value) => handleChange('idiomaPlataforma', value)}>
              <SelectTrigger>
                <SelectValue placeholder="Selecione o idioma" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="portugues">Português</SelectItem>
                <SelectItem value="ingles">Ingl
...
ês</SelectItem>
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('exibirPerfilPublicamente', checked)}
            />
            <Label htmlFor="exibirPerfilPublicamente">Exibir Perfil Publicamente</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Switch
              id="permitirContatoDireto"
              checked={config.permitirContatoDireto}
              onCheckedChange={(checked) => handleChange('permitirContatoDireto', checked)}
            />
            <Label htmlFor="permitirContatoDireto">Permitir Contato Direto</Label>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="percentualImpostos">Percentual de Impostos (%)</Label>
            <Input 
              id="percentualImpostos" 
              type="number" 
              value={config.percentualImpostos} 
              onChange={(e) => handleChange('percentualImpostos', Number(e.target.value))}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleNestedChange('cnh', 'numero', e.target.value)} 
            />
            <Input 
              type="date" 
              placeholder="Validade da CNH" 
              value={config.cnh.validade} 
              onChange={(e) => handleNestedChange('cnh', 'validade', e.target.value)} 
            />
          </div>
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleNestedChange('seguroVeiculo', 'numero', e.target.value)} 
            />
            <Input 
              type="date" 
              placeholder="Validade do Seguro" 
              value={config.seguroVeiculo.validade} 
              onChange={(e) => handleNestedChange('seguroVeiculo', 'validade', e.target.value)} 
            />
          </div>
          <div className="space-y-2">
            ...
            <Button 
              variant="outline" 
              onClick={() => handleChange('certificacoes', [...config.certificacoes, ''])}
            >
