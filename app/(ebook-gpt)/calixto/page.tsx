              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-sm text-zinc-500 text-center">
                    Conheça uma turma peculiar de cães, cada um com sua própria
                    agenda e personalidade única.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-sm text-zinc-500 text-center">
                    Uma história cheia de reviravoltas, perseguições e esquemas
                    audaciosos que vai te prender do início ao fim.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent className="flex items-center gap-4 p-6">
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-zinc-500">
                      Calixto tem um talento natural para elaborar esquemas
                      complexos e convencer até o mais cético dos cães.
                    </p>
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex items-center gap-4 p-6">
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-zinc-500">
                      Nascido no Frigorífico Bordon, o passado de Calixto é tão
                      intrigante quanto seus golpes atuais.
                    </p>
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex items-center gap-4 p-6">
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-zinc-500">
                      Mesmo em apuros, Calixto sempre tem um truque na manga e
                      um sorriso no rosto.
                    </p>
                  </div>
                </CardContent>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-zinc-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  Salsicha: O Golpe do Terreno Fantasma", ele traz sua primeira
                  incursão no mundo da literatura canina, mesclando sua
                  experiência em narrativas de suspense com um toque de humor
                  único.
                </p>
              </div>
            </div>
