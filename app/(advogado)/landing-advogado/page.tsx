    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Gerencie casos, clientes e documentos com facilidade. Aumente sua produtividade e foque no que realmente importa.
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <p className="text-muted-foreground">Proteja as informações sensíveis dos seus clientes com nossa plataforma altamente segura.</p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                <Briefcase className="h-12 w-12" />
                <h3 className="text-xl font-bold">Gestão de casos</h3>
                <p className="text-muted-foreground">Organize e acompanhe todos os seus casos em um único lugar, aumentando sua eficiência.</p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                <Scale className="h-12 w-12" />
                <h3 className="text-xl font-bold">Faturamento simplificado</h3>
                <p className="text-muted-foreground">Automatize seu processo de faturamento e receba pagamentos mais rapidamente.</p>
              </div>
            </div>
          </div>
        </section>
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">Planos e preços</h2>
            <div className="grid gap-8 md:grid-cols-3">
              ...
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex flex-col p-6 bg-muted rounded-lg">
                  ...
                  <p className="text-muted-foreground mb-4">
                    "JurisLex revolucionou minha prática jurídica. Agora posso gerenciar meus casos com muito mais eficiência."
                  </p>
                  <p className="font-bold">Dr. João Silva</p>
                  <p className="text-sm text-muted-foreground">Advogado, {["São Paulo", "Rio de Janeiro", "Belo Horizonte"][i]}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="cta" className="w-full py-12 md:py-24 lg:py-32 bg-primary text-primary-foreground">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Pronto para transformar sua prática jurídica?</h2>
              <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
                Junte-se a milhares de advogados que já estão usando o JurisLex para simplificar seu trabalho.
              </p>
              <div className="w-full max-w-sm space-y-2">
                <form className="flex space-x-2">
                  <Input className="flex-1" placeholder="Seu e-mail" type="email" />
      ...
      <footer id="contact" className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">© 2024 JurisLex. Todos os direitos reservados.</p>
