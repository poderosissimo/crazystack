                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <Avatar>
                          <AvatarImage
                            src={`/placeholder.svg?height=40&width=40&text=${appointment.salonName[0]}`}
                          />
                          <AvatarFallback>
                            {appointment.salonName[0]}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                ...
                <Card key={appointment.id}>
                  ...
                  <CardFooter className="flex justify-end">
                    {appointment.status === "completed" && (
                      <Button variant="outline">Avaliar Serviço</Button>
                    )}
                  </CardFooter>
                </Card>
              ))}
      ...
      >
        <DialogContent>
          ...
          <div className="grid gap-4">
            ...
            />
            <Select
              onValueChange={(value) => confirmReschedule(selectedDate!, value)}
            >
              <SelectTrigger>
          ...
          <DialogFooter>
            <Button
              variant="outline"
              onClick={() => setIsReschedulingDialogOpen(false)}
            >
              Cancelar
            </Button>
            <Button onClick={() => confirmReschedule(selectedDate!, "09:00")}>
              Confirmar
            </Button>
          </DialogFooter>
        </DialogContent>
