...
export default function Page() {
  const mock = {
    salonId: "1",
    name: "Salão de Beleza da Maria",
    rating: 4.5,
    totalReviews: 12,
    address: "Rua das Flores, 123",
    openingHours: "Segunda a Sexta, 09:00 - 18:00",
    phone: "(11) 99999-9999",
      ...
      <Card className="mb-8">
        <CardHeader className="flex flex-row items-center space-x-4">
          <Avatar className="h-20 w-20">
            <AvatarImage
              src={`/placeholder.svg?height=80&width=80&text=${getAvatarFallback(name)}`}
              alt={name}
            />
      ...
      <Dialog open={isBookingDialogOpen} onOpenChange={setIsBookingDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedService
                ? `Agendando: ${selectedService.name}`
          ...
          <div className="grid gap-4">
            ...
            />
            <Select
              onValueChange={(value) => handleBooking(selectedDate!, value)}
            >
              <SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => handleBooking(selectedDate!, "09:00")}>
