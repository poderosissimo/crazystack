...
const screenTypes = [
  ...
  { value: "list", label: "Listagem com scroll infinito" },
  { value: "pagamentoPix", label: "Pagamento via Pix" },
  { value: "pagamentoCartao", label: "Pagamento via cartão de crédito" },
  { value: "minhaAssinatura", label: "Minha assinatura do SaaS" },
  { value: "cupom", label: "Cupom de desconto" },
  { value: "user_management", label: "Gerenciamento de Usuários" },
  { value: "billing", label: "Faturamento" },
  { value: "notifications", label: "Notificações" },
  { value: "activity_log", label: "Minhas Atividades" },
  { value: "project_overview", label: "Visão Geral da minha conta" },
  { value: "user_feedback", label: "avaliações do Usuário" },
  { value: "release_notes", label: "Notas de Versão" },
  { value: "changelog", label: "Histórico de Pedidos" },
  { value: "security", label: "Segurança" },
  { value: "admin_panel", label: "Painel de Pedidos" },
  { value: "content_management", label: "Gerenciamento de clientes" },
  { value: "knowledge_base", label: "lista geolocalizada" },
  { value: "upgrade_plan", label: "Atualizar Plano" },
  { value: "file_manager", label: "upload de arquivos múltiplo" },
  { value: "search", label: "Busca textual" },
  { value: "inbox", label: "minhas mensagens" },
  { value: "calendar", label: "Calendário" },
  { value: "tasks", label: "Tarefas" },
  { value: "reports", label: "Relatórios" },
  { value: "leaderboard", label: "Ranking" },
  { value: "referrals", label: "Indicações" },
  { value: "rewards", label: "fidelidades" },
...
export default function SaasUIGenerator() {
  ...
  const [advancedParams, setAdvancedParams] = useState({
    ...
    "animated Transitions": true,
    "error Handling": false,
    "atomic design":false,
    "clean code":true,
    "clean architecture":false,
    "feature sliced design":false,
    supabase:false,
    firebase:false,
    useCallback:true,
    useMemo:true,
    "solid Principles":false,
    "detailed mocks":false,
    reactHookForm:true,
    zodValidation:true,
    datefns:true
  })
...
${advancedFeatures}.
Do not use tool, paw, PayPal icon, repeat, save,moon,paint and social network icons. Create 30 parameters. If the code repeats more than once, create a reusable component in same file.
`;
