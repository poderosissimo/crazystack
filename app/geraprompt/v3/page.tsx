...
export default function SaasUIGenerator() {
  ...
  const [advancedParams, setAdvancedParams] = useState({
    ...
    internacionalização: false,
    errorHandling: false,
    loadingStates: false,
  })

  useEffect(() => {
    if (screenType in suggestions) {
      setScreenParams(prev => ({
        ...prev,
        name: suggestions[screenType].title,
        description: suggestions[screenType].description,
        primaryAction: suggestions[screenType].primaryAction,
        secondaryAction: suggestions[screenType].secondaryAction,
      }))
    }
  }, [screenType])
