    ...
    <div className="flex flex-col min-h-screen bg-background">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    PedreirosPro é a ferramenta perfeita para pedreiros e
                    construtores gerenciarem projetos, clientes e orçamentos em
                    um só lugar.
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Experimente o PedreirosPro gratuitamente por 14 dias. Sem
                    compromisso.
                  </p>
                </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Gerencie todos os seus projetos, clientes e orçamentos em uma
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Agende visitas e trabalhos com facilidade, evitando conflitos
                  de horários.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Crie orçamentos detalhados e profissionais em minutos,
                  impressionando seus clientes.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 PedreirosPro. Todos os direitos reservados.
        </p>
