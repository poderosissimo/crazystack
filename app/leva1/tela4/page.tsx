    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
            ...
            <div>
              ...
              {password && (
                <p className="text-sm mt-1">
                  Força da senha: <span className="font-medium">{passwordStrength(password)}</span>
                </p>
              )}
            </div>
          ...
          <div className="mt-6">
            <p className="text-center text-sm text-gray-600 mb-4">Ou entre com</p>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            <p>Não tem uma conta? <a href="#" className="text-blue-600 hover:underline">Registre-se</a></p>
          </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-8">
          ...
          <p className="text-xl mb-8 text-center">Transforme suas ideias em realidade</p>
