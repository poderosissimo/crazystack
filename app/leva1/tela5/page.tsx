...
import { Hammer, ShoppingBag, Briefcase, Tool, Bell, Search, Menu } from "lucide-react"
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className={`bg-white w-64 min-h-screen p-4 ${isSidebarOpen ? 'block' : 'hidden'} md:block`}>
        ...
        <nav>
          ...
          <Button variant="ghost" className="w-full justify-start mb-2">
            <Tool className="mr-2 h-4 w-4" /> Ferramentas
          </Button>
        </nav>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex-shrink-0 flex items-center">
                <Input type="search" placeholder="Pesquisar..." className="w-full max-w-xs" />
        ...
        <main className="flex-1 overflow-auto p-4">
          <div className="max-w-7xl mx-auto">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  {[1, 2, 3].map((job) => (
                    <Card key={job}>
                      ...
                      <CardContent>
                        <p>Procura-se pedreiro para reforma de banheiro e cozinha.</p>
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Ferramentas e Serviços</h2>
