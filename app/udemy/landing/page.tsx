      ...
      <header className="bg-white border-b border-gray-200">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          <div className="flex items-center">
            ...
            <Image src="/placeholder.svg" alt="Udemy" width={91} height={34} />
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button className="hidden md:inline-flex bg-black text-white hover:bg-gray-800">
              Sign up
            </Button>
  ...
  return (
    <div className="relative flex-1 max-w-xl">
      <Input
        ...
        className="w-full pl-10 pr-4 py-2 border-2 border-gray-700 rounded-full focus:border-purple-600 focus:ring-0"
      />
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center mb-2">
                    ...
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`w-4 h-4 ${i < Math.floor(course.rating) ? "fill-orange-400 text-orange-400" : "text-gray-300"}`}
                        />
                      ))}
                    </div>
                  ...
                  <span className="inline-block mt-2 text-xs font-semibold bg-yellow-100 text-yellow-800 px-2 py-1 rounded">
                    Bestseller
                  </span>
                </div>
              </div>
  ...
  const topics = [
    {
      ...
      items: ["Python", "Web Development", "Machine Learning"],
    },
    { category: "Business", items: ["Financial Analysis", "SQL", "PMP"] },
    {
      category: "IT and Software",
      items: ["Amazon AWS", "Ethical Hacking", "Cyber Security"],
    },
        ...
        <div className="flex flex-wrap justify-center items-center gap-8">
          {companies.map((company) => (
            <Image
              src="/placeholder.svg"
              key={company}
              // src={`/${company.toLowerCase().replace(" ", "-")}-logo.svg`}
              alt={company}
              width={120}
              height={40}
            />
